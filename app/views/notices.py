...
def list_notices():
    ...
    if current_user.is_authenticated:
        ...
        # pagination = db.session.query(Notice).filter_by(status=2).order_by(Notice._created_time.desc()).paginate(page, 10, False)
        pagination =  Notice.list_paginate_latest_notices(page, 10)
