...
from app.model_views import TagModelView, UserModelView, NoticeModelView, AdminIndexView, VisitorModelView, CommentModelVise, init_login, init_sample_users
...
admin.add_view(CommentModelVise())
...
register_model_view_permission(CommentModelVise, '普通管理员')
